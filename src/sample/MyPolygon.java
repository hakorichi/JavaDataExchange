...
public class MyPolygon extends Graph_obj implements Serializable
{
    ...
    public void draw(Group root)
    {
        ...
        for(int i = 0; i <= _n; i++)
        {
            ...
            double Angle = rotation +  ((double)i)/(_n) * 2 * Math.PI;
            ...
            if (i > 0)
            {
                ...
                double Brightness =          (Math.cos(Angle) + 1) / 2 * 0.7 + 0.3;
                ...
                double s = 0.5;
                list.add(x + xxOld  * s); //x
                list.add(y + yyOld  * s); //y
                ...
                list.add(x + xx  * 0.8);
                list.add(y + yy  * 0.8);
                list.add(x + xxOld  * 0.8);
                list.add(y + yyOld  * 0.8);
                list.add(x);
                list.add(y);
                polygon = new Polygon();
                polygon.getPoints().addAll(list);
